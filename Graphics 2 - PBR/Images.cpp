...
void Image::copyDataToGPU(StagingBuffer* stagingBuffer, VkDeviceMemory memory, VkDeviceSize startingOffset)
{
        ...
        vkCreateImageView(
            ...
            VkImageViewCreateInfo{
                ...
                .subresourceRange = VkImageSubresourceRange{
                    ...
                    .baseMipLevel=0,
                    .levelCount=unsigned(this->layers[0].mips.size()),
                    .baseArrayLayer=0,
                    .layerCount=(unsigned)this->numLayers
                }
            },
            nullptr,
            &(this->view_)
    ...
    for(int i=0;i<(int)this->layers.size();++i){
        ...
        ctx->setObjectName(view,"image "+this->name+" layer "+std::to_string(i));
        this->layers[i].view_ = view;
    }
...
static void doBarrier( VkCommandBuffer cmd, VkImageAspectFlags aspect,
    ...
    ctx->insertCmdLabel(cmd,"barrier layers:",firstLayer,numLayers,"mips:",firstMip,numMips);

...
void setup(Globals& globs)
{
    ...
    globs.descriptorSetLayout = new DescriptorSetLayout(
        globs.ctx,
        {
            ...
            {.type = VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE,    .slot = METALLICROUGHNESS_TEXTURE_SLOT    },
             ...
             {.type = VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE,   .slot = PROJECTED_TEXTURE_SLOT  }
        }
    );
    ...
    globs.projectedTexture = ImageManager::load("assets/window4.png");
    ...
    gltf::GLTFScene scene = gltf::parse("assets/gothic-merged.glb");
    ...
    globs.camera.lookAt(
        vec3(-1.291233f, 6.339142f, 7.184764f),
        vec3(-1.935978f, 6.199058f, 6.433239f),
        vec3(-0.091209f, 0.990144f, -0.106315f)
    );

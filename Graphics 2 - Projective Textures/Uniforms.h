...
//~ void initialize(VulkanContext* ctx, const std::vector<DescriptorSet*>&,
                 //~ int descriptorSetSlot, std::string uniformFile);
//~ void initialize(VulkanContext* ctx, const std::vector<std::vector<DescriptorSet*>>&,
                 //~ int descriptorSetSlot, std::string uniformFile);
//~ void set(std::string name, std::int32_t value);
//~ void set(std::string name, std::uint32_t value);
//~ void set(std::string name, float value);
//~ void set(std::string name, double value);
//~ void set(std::string name, math2801::ivec2 value);
//~ void set(std::string name, math2801::vec2 value);
//~ void set(std::string name, math2801::vec3 value);
//~ void set(std::string name, math2801::vec4 value);
//~ void set(std::string name, math2801::mat4 value);
//~ void set(std::string name, const std::vector<math2801::vec4>& value);
//~ void update(int frameNumber, VkCommandBuffer cmd);

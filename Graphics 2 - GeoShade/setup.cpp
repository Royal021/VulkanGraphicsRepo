...
void setup(Globals& globs)
{
    ...
    globs.grassPipeline = globs.pipeline->clone("grass")
        ->set(ShaderManager::load("shaders/grass.vert"))
        ->set(ShaderManager::load("shaders/grass.geom"))
        ->set(ShaderManager::load("shaders/grass.frag"));
    ...
    gltf::GLTFScene scene = gltf::parse("assets/fur.glb");
